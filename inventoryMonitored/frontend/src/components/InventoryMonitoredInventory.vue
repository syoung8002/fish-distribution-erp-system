<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-actions>
            ...
            <v-dialog v-model="adjustInventoryDiagram" width="500">
                <AdjustInventoryCommand
                    @closeDialog="closeAdjustInventory"
...
<script>
    ...
    export default {
        name: 'InventoryMonitoredInventory',
        props: {
        ...
        methods: {
            ...
            openAdjustInventory() {
                this.adjustInventoryDiagram = true;
            },
            closeAdjustInventory() {
                this.adjustInventoryDiagram = false;
            },
        },
    }
</script>
